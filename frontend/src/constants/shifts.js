export const shiftDays = ["M", "E", "N", "OFF", "V", "MH", "EH", "NH"]
...
export const postTitles = [
    ...
    "7.کاردان‌اتاق‌عمل", "8.کاردان‌بیهوشی", "9.بهیار", "10.کمک‌بهیار", "11.بهورز"
]
export const employTitles = ["1.رسمی", "2.پیمانی", "3.تبصره(۳)", "4.قراردادی", "5.طرحی"]